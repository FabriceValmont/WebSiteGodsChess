  ...
  return (
    <div className="bg-black flex text-white">
      <div className="m-4 text-center flex flex-col justify-center align-center items-center">
        ...
        <p className="text-lg">Dans ce mode de jeu vous utilisé le pouvoir passif du dieu choisi pour l’ensemble des pièces contre un autre dieu. Ensuite, à vous de tirer partie de la spécificité de chaque pièces pour vous menez à la victoire!</p>
      </div>
      <div className="m-4">
